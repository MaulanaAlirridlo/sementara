                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
                                ...
                                ?>
                                    <div>
                                        <a href="{{ route('beranda') }}"><img style="width: 100px" src="<?= Storage::url("images/" . $name) ?>" alt="<?= $alt_name ?>"/></a>
                                    </div>
                                <?php } ?>
                            </div>
                    ...
                    <div class="row pt-5 mt-5 text-center">
                        <div class="col-md-12">
                            <p>
                                ...
                                Copyright &copy;<script data-cfasync="false" src="https://www.cloudflare.com/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> G-Enterprise. All rights reserved</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
                    </div>
